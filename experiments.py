...
@ti.kernel
def flatten_rope_positions(rid: ti.template(), flattened_positions: ti.template()):
...
flattened_positions_taichi = ti.field(dtype=ti.f32, shape=flattened_positions.shape)
flattened_positions_taichi.from_numpy(flattened_positions)
